...
NSString *NSExcludedKeysBinding = @"excludedKeys";
...
NSString *NSInitialKeyBinding = @"initialKey";
NSString *NSInitialValueBinding = @"initialValue";
NSString *NSLocalizedKeyDictionaryBinding = @"localizedKeyDictionary";
NSString *NSManagedObjectContextBinding = @"managedObjectContext";
