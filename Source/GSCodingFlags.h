...
typedef struct __attribute__((packed)) _GSCellFlags 
{
...
typedef struct __attribute__((packed)) _GSCellflags2 
{
#if GS_WORDS_BIGENDIAN == 1
...
typedef struct __attribute__((packed)) _GSButtonCellFlags
{
#if GS_WORDS_BIGENDIAN == 1
...
typedef struct __attribute__((packed)) _GSButtonCellFlags2
{
#if GS_WORDS_BIGENDIAN == 1
...
typedef struct __attribute__((packed)) _GSvFlags
{
#if GS_WORDS_BIGENDIAN == 1
...
typedef struct __attribute__((packed)) _GSTabViewTypeFlags
{
#if GS_WORDS_BIGENDIAN == 1
 ...
 * in the flags.
 */
typedef struct __attribute__((packed)) _tableViewFlags
{
#if GS_WORDS_BIGENDIAN == 1
...
typedef struct __attribute__((packed)) _GSMatrixFlags
{
#if GS_WORDS_BIGENDIAN == 1
